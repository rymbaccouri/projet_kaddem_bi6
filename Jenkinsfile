     ...
     stage('Configure Grafana') {
                                    steps {
                                        script {
                                            ...
                                            sh 'curl -X POST -H "Content-Type: application/json" -d \'{"dashboard": {...}}\' http://192.168.43.141:3000/d/haryan-jenkins/jenkins3a-performance-and-health-overview?orgId=1'
                                        }
                                    }
                             }
